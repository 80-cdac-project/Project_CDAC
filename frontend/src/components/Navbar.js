...
export default function Navbar(){
    ...
    <div>
        <nav className="navbar fixed-top navbar-expand-lg navbar-dark bg-gradient text-black fw-bold ">
         ...
         <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <Link className="nav-link active" aria-current="page" to="/">Home</Link>
            ...
            <>
            <li className="nav-item">
            <Link className="nav-link active" aria-current="page" to="/owners">Property Owner</Link>
            </li>
            <li className="nav-item">
            <Link className="nav-link active" aria-current="page" to="/users">Users</Link>
            </li>
            <li className="nav-item">
            <Link className="nav-link active" aria-current="page" to="/apartments">Property</Link>
            </li>
            <li className="nav-item">
          ...
          <Link className="nav-link active" aria-current="page" to="/cregister">User Register</Link>
           ...
           <li className="nav-item">
          <Link className="nav-link active" aria-current="page" to="/oregister">Property Owner Register</Link>
           </li>
           <li className="nav-item">
