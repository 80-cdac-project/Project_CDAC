        ...
        <div className="container mt-5">
            <div className="row">
                <div className="col-sm-5">
                    {data?.isactive ? (
                    <button onClick={e=>deleteApartment(data?.id)} className="btn btn-outline-danger btn-sm float-end">Deactivate Package</button>
                    ) :(
                        <button onClick={e=>activateApartment(data?.id)} className="btn btn-success btn-sm float-end">Activate Pacakge</button>
                    )}
