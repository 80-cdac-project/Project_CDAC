...
function OwnerRegisterTable() {
  ...
  return (
    <div className="container mt-5" style={{backgroundColor:"plum"}}>
      <div className="title">Property Owner Registration Form</div>
      <form onSubmit={handleSubmit}>
        ...
        <div className="button">
          <input type="submit" className="submit bg-gradient" value="Submit" />
        </div>
      </form>
    </div>
  );
